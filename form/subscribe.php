...
$receiving_email_address = "newsletter@hec.one";  // Set your email address here which you want to receive emails to

$custom_subject = "Newsletter subscriber"; // Change the subject line of email as per your choice.
